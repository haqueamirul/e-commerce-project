                          ...
                          ?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{('/product_by_category/'.$single_cat->cat_id)}}">{{ $single_cat->cat_name }}</a></h4>
                                </div>
                            </div>
                        <?php endforeach; ?>
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                ...
                                <?php
                                  ...
                                  ?>
                                    <li><a href="{{('/product_by_menufacture/'.$single_brand->menufacture_id)}}"> <span class="pull-right">(50)</span>{{ $single_brand->menufacture_name }}</a></li>
                                <?php endforeach; ?>
                                </ul>
                            </div>
                        </div><!--/brands_products-->
