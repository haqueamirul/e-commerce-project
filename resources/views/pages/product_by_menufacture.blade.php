...
<h2 class="title text-center">Features Items</h2>
    ...
    <?php 
        foreach ($product_by_menufactures as $single_product) {
        ...
        <div class="product-image-wrapper">
            <div class="single-products">
                    <div class="productinfo text-center">
                        <img src="{{URL::to($single_product->product_image)}}" alt="" />
                        <h2>{{$single_product->product_price}} Tk</h2>
            ...
            <div class="choose">
                <ul class="nav nav-pills nav-justified">
                    <li><a href="#"><i class="fa fa-plus-square"></i>{{$single_product->menufacture_name}}</a></li>
