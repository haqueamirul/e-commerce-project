	...
	<div class="product-details"><!--product-details-->
		...
		<div class="col-sm-7">
			<div class="product-information"><!--/product-information-->
				...
				<p><span style="font-size: 20px; color: #f4hg5j">Color:</span> {{$product_by_details->product_color}}</p>
				...
				<p><b>Brand:</b> {{$product_by_details->menufacture_name}}</p>
				<p><b>Category:</b> {{$product_by_details->cat_name}}</p>
