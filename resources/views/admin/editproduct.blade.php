			...
			{{ csrf_field() }}
			  <fieldset>
				<div class="control-group">
				  ...
				  <div class="controls">
					<input type="text" class="span6 typeahead" name="product_name" id="typeahead" value="{{$edit_product_info->product_name}}" required="">
				  </div>
				</div>   
				<div class="control-group">
					...
					<div class="controls">
					  <select id="selectError3" name="cat_id">
						<option>{{$edit_product_info->cat_name}}</option>
						 <?php
				  ...
				  <div class="control-group">
					...
					<div class="controls">
					  <select id="selectError2" name="menufacture_id">
						<option>{{$edit_product_info->menufacture_name}}</option>
						 <?php
				...
				<div class="control-group hidden-phone">
				  ...
				  <div class="controls">
					<textarea class="cleditor" id="textarea2" name="product_short_description" rows="3">{{$edit_product_info->product_short_description}}</textarea>
				  </div>
				</div>
				<div class="control-group hidden-phone">
				  <label class="control-label" for="textarea1">Product Long Description: </label>
				  <div class="controls">
					<textarea class="cleditor" id="textarea1" name="product_long_description" rows="3">{{$edit_product_info->product_long_description}}</textarea>
				  </div>
				</div>
				<div class="control-group">
				  <label class="control-label" for="typeahead">Product Price:  </label>
				  <div class="controls">
					<input type="text" class="span6 typeahead" name="product_price" id="typeahead" value="{{$edit_product_info->product_price}}" required="">
				  </div>
				</div>
				<div class="control-group">
				  ...
				  <div class="controls">
					...
					<img src="{{$edit_product_info->product_image}}" style="width: 80px; height: 80px;">
				  </div>
				</div>
				<div class="control-group">
				  <label class="control-label" for="typeahead">Product Size:  </label>
				  <div class="controls">
					<input type="text" class="span6 typeahead" name="product_size" id="typeahead" value="{{$edit_product_info->product_size}}">
				  </div>
				</div>
				<div class="control-group">
				  <label class="control-label" for="typeahead">Product Color:  </label>
				  <div class="controls">
					<input type="text" class="span6 typeahead" name="product_color" id="typeahead" value="{{$edit_product_info->product_color}}">
				  </div>
				</div> 
				<div class="control-group">
